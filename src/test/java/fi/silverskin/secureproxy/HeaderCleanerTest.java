...
public class HeaderCleanerTest {
    ...
    public void testmaskLocationHeader() throws URISyntaxException {
        ...
        expectedHeaders.put("user-agent", "Mozilla/5.0 (iPad; U; CPU OS 3_2_1 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Mobile/7B405");
        ...
        expectedHeaders.put("cookie", "PART_NUMBER=RIDING_ROCKET_0023; PART_NUMBER=ROCKET_LAUNCHER_0001");
        expectedHeaders.put("content-type", "text/html");
        expectedHeaders.put("Location", "http://palomuuri.users.cs.helsinki.fi:80/blog/index.php");

        response.setHeaders(testHeaders);
        EPICResponse result = HeaderCleaner.maskLocationHeader(response, configuration);
